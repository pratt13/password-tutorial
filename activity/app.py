...
from helpers import level_one, level_two, level_three, level_four
from helpers import bad_password_generator, pin_number
...
@auth.login_required(role=[TERRY, ADMIN])
def secrets_terry():
...
def level1a():
    if request.method == "GET":
        ...
        return _return_success(
            request.headers, message="Well done for solving level 1a!", next_task="level1b"
        )
...
def level1b():
    if request.method == "GET":
        return render_template(
            "task2/input.html", info="Level 1b - enter an 8 character password with a number"
        )
        ...
        return _return_success(
            request.headers, message="Well done for solving level 1b!", next_task="level1c"
        )
...
def level1c():
    if request.method == "GET":
        return render_template(
            "task2/input.html",
            info="Level 1c - enter an 8 character password with a number and capital letter",
        )
        ...
        return _return_success(
            request.headers, message="Well done for solving level 1c!", next_task="level1d"
        )
...
def level1d():
    if request.method == "GET":
        return render_template(
            "task2/input.html",
            info="Level 1d - enter an 8 character password with a number, capital letter and special character.",
        )
        ...
        return _return_success(
            request.headers, message="Well done for solving level 1d!", next_task="level1e"
        )
...
def level1e():
    if request.method == "GET":
        return render_template(
            "task2/input.html",
            info="Level 1e - enter an 8 character password with a number, capital letter, special character and no common patterns.",
        )
        ...
        level_one(password)
        return _return_success(
            request.headers, message="Well done for solving level 1e!", next_task="level2"
        )
...
def level2():
    if request.method == "GET":
        return render_template(
            "task2/input.html",
            info="Level 2 - enter a password that has an expected high complexity",
        )
        ...
        level_two(password)
        return _return_success(
            request.headers, message="Well done for solving level 2!", next_task="level3"
        )
...
def level3():
    if request.method == "GET":
        return render_template(
            "task2/input.html", info="Level 3 - enter a password that has a high complexity"
        )
        ...
        return _return_success(
            request.headers, message="Well done for solving level 3!", next_task="level4"
        )
...
def level4():
    ...
    return _return_success(
        request.headers, message="Well done for solving level 4!", next_task="level5"
    )
...
def level5():
    ...
    if max(char_counter.values()) > mean * 5:
        raise InvalidPasswordException(
            "Some characters appear unexpectedly often - is it really  at random"
        )

    return _return_success(
        request.headers, message="Well done for solving level 5!", next_task=None
    )
